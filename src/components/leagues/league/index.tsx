...
import PlayersStatsSeason from "./playersStats/playersStatsSeason";
...
import PlayersStatsTotal from "./playersStats/playersStatsTotal";
import PlayersStatsPerSeason from "./playersStats/playersStatsPerSeason";
