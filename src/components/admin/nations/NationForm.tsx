...
const NationForm = ({
  ...
  const prepareImagesForSave = async (values: FormValues) => {
    ...
    return { ...values, flag: finalFlagPath, logo: finalLogoPath };
  };
  ...
  const formik = useFormik<FormValues>({
    ...
    onSubmit: async (values) => {
      setSaving(true);
      try {
        const finalValues = await prepareImagesForSave(values);
